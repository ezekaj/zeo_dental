      ...
      <div className="relative z-10 w-full min-h-screen flex flex-col justify-center items-center text-center px-6 py-20">
        <Reveal>
          <h1 className="flex flex-col items-center justify-center text-white leading-[0.85]">
            <span className="font-serif italic font-light text-[clamp(2.5rem,10vw,8vw)] md:text-[8vw] tracking-tight opacity-90">
              {t('hero.artOf')}
            </span>
            <span className="font-serif font-normal text-[clamp(3rem,13vw,12vw)] md:text-[12vw] tracking-tighter mt-2">
              {t('hero.dentistry')}
            </span>
          </h1>
        </Reveal>
