...
import { Sparkles, Anchor, Smile, HeartPulse, Activity, Baby, ArrowRight } from 'lucide-react';
...
interface ServicesProps {
  onNavigate?: (
    view: 'home' | 'booking' | 'service-detail',
    sectionId?: string,
    serviceParam?: string
  ) => void;
}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {SERVICES.map(service => {
            ...
            return (
              <div
                key={service.id}
                className="group p-8 border border-primary-100 rounded-2xl bg-white hover:bg-primary-50 hover:shadow-2xl hover:shadow-[0_20px_50px_rgba(153,125,91,0.15)] transition-all duration-300 transform hover:-translate-y-1"
              >
                ...
                <h4 className="text-xl font-serif font-semibold text-slate-900 mb-3">
