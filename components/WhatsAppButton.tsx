...
export const WhatsAppButton: React.FC = () => {
  ...
  return (
    <a
      ...
      className={`fixed bottom-6 left-6 z-50 p-4 rounded-full shadow-2xl transition-all duration-500 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 group ${
        isOverDark
