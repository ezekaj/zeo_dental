...
echo "[1/14] Waiting for ManagerCRM to start..."
...
echo "[2/14] Setting application name to ManagerCRM..."
...
# Patch navbar link
echo "[4/14] Updating navbar brand link..."
...
echo "[5/14] Applying Z.E Digital Tech branding..."
...
echo "[6/14] Installing Guided Tour module..."
...
echo "[7/14] Injecting tour into main page..."
...
echo "[8/14] Importing Albanian translations..."
...
echo "[11/14] Configuring dental procedures and settings..."
...
echo "[12/14] Configuring email notifications..."
if [ -n "${SMTP_HOST:-}" ]; then
  docker exec "$CONTAINER" mysql -h crm-ze-db -u root -proot openemr -e "
...
echo "[13/14] Configuring document management..."
docker exec "$CONTAINER" mysql -h crm-ze-db -u root -proot openemr -e "
